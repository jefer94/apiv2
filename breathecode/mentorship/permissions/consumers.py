...
def mentorship_service_by_url_param(
    context: PermissionContextType, args: tuple, kwargs: dict
    ...
    if (
        ...
        raise ValidationException(
            translation(
                ...
                es="El mentee no tiene suficientes créditos para acceder a este servicio: " f'{context["permission"]}',
            ),
