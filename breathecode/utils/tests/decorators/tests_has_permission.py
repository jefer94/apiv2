...
def build_view_function(
    methods, data, decorator, decorator_args=(), decorator_kwargs={}, with_permission=False, with_id=False
):
...
get_consumer = build_view_function(
    ["GET"], GET_RESPONSE, decorators.has_permission, decorator_args=(PERMISSION,), decorator_kwargs={"consumer": True}
)

get_consumer_callback = build_view_function(
    ["GET"],
    GET_RESPONSE,
...
get_id = build_view_function(
    ["GET"], GET_ID_RESPONSE, decorators.has_permission, decorator_args=(PERMISSION,), with_id=True
)

get_id_consumer = build_view_function(
    ["GET"],
    GET_ID_RESPONSE,
    decorators.has_permission,
    decorator_args=(PERMISSION,),
...
get_id_consumer_callback = build_view_function(
    ["GET"],
    GET_ID_RESPONSE,
    decorators.has_permission,
    decorator_args=(PERMISSION,),
...
post_consumer = build_view_function(
    ["POST"],
    POST_RESPONSE,
    decorators.has_permission,
    decorator_args=(PERMISSION,),
...
post_consumer_callback = build_view_function(
    ["POST"],
    POST_RESPONSE,
    decorators.has_permission,
    decorator_args=(PERMISSION,),
...
put_id = build_view_function(
    ["PUT"], PUT_ID_RESPONSE, decorators.has_permission, decorator_args=(PERMISSION,), with_id=True
)

put_id_consumer = build_view_function(
    ["PUT"],
    PUT_ID_RESPONSE,
    decorators.has_permission,
    decorator_args=(PERMISSION,),
...
put_id_consumer_callback = build_view_function(
    ["PUT"],
    PUT_ID_RESPONSE,
    decorators.has_permission,
    decorator_args=(PERMISSION,),
...
delete_id = build_view_function(
    ["DELETE"], DELETE_ID_RESPONSE, decorators.has_permission, decorator_args=(PERMISSION,), with_id=True
)

delete_id_consumer = build_view_function(
    ["DELETE"],
    DELETE_ID_RESPONSE,
    decorators.has_permission,
    decorator_args=(PERMISSION,),
...
delete_id_consumer_callback = build_view_function(
    ["DELETE"],
    DELETE_ID_RESPONSE,
    decorators.has_permission,
    decorator_args=(PERMISSION,),
...
TestViewConsumer = build_view_class(
    decorators.has_permission, decorator_args=(PERMISSION,), decorator_kwargs={"consumer": True}
)

TestViewConsumerCallback = build_view_class(
    decorators.has_permission, decorator_args=(PERMISSION,), decorator_kwargs={"consumer": CONSUMER_MOCK}
)
...
class ConsumerFunctionBasedViewTestSuite(UtilsTestCase):
    ...
    def test__function__get__with_user__with_group_related_to_permission__consumable__how_many_minus_1(self):
        ...
        self.assertEqual(
            payments_signals.consume_service.send.call_args_list,
            [
...
class ConsumerFunctionCallbackBasedViewTestSuite(UtilsTestCase):
    ...
    def test__view__get__with_user__consumption_session__does_not_match(self):
        ...
        model = self.bc.database.create(
            user=user, permission=permissions, group=group, consumable=consumable, consumption_session=1
        )
    ...
    def test__view__get_id__with_user__consumption_session__does_not_match__consumables_minus_sessions_et_0(self):
        ...
        consumption_session = {
            "eta": UTC_NOW + time_of_life,
            "how_many": n,
            "request": {"args": [], "kwargs": {"id": 1}, "headers": {"academy": None}, "user": 1},
        }
        model = self.bc.database.create(
            user=user,
            permission=permissions,
