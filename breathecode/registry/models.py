...
class Asset(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        if readme_modified:
            asset_readme_modified.send(instance=self, sender=Asset)
        if title_modified:
            asset_title_modified.send(instance=self, sender=Asset)
        if status_modified:
            asset_status_updated.send(instance=self, sender=Asset)
